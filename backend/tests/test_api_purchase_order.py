...
async def test_reject_transitions_pending_to_rejected_with_comment(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
...
async def test_reject_with_empty_comment_returns_422(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    po = await _create_po(client)
    await client.post(f"/api/v1/po/{po['id']}/submit")
...
async def test_reject_with_missing_comment_returns_422(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    po = await _create_po(client)
    await client.post(f"/api/v1/po/{po['id']}/submit")
...
async def test_update_rejected_po_returns_revised_status(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    po = await _create_po(client)
    await client.post(f"/api/v1/po/{po['id']}/submit")
...
async def test_update_non_rejected_po_returns_409(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    po = await _create_po(client)
...
async def test_resubmit_revised_returns_pending(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    po = await _create_po(client)
    await client.post(f"/api/v1/po/{po['id']}/submit")
...
async def test_full_lifecycle(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
...
async def test_bulk_reject_requires_comment(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
    resp = await client.post("/api/v1/po/bulk/transition", json={"po_ids": ["some-id"], "action": "reject"})
    assert resp.status_code == 422


async def test_bulk_reject_with_comment_succeeds(authenticated_client: AsyncClient) -> None:
    client = authenticated_client
