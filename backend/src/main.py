...
from src.routers import activity, certificate, dashboard, document, invoice, milestone, packaging, product, purchase_order, qualification_type, reference_data, vendor
